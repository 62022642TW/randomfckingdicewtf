...
if (num1 > num2 && num1 > num3 ) {
    ...
    document.querySelector("h1").innerHTML = " Player 1 and 2  Wins!"
}
else if (num3 == num2 && num3 > num1){
    document.querySelector("h1").innerHTML = " Player 2 and 3  Wins!"
}
else if (num3 == num1 && num3 > num2){
document.querySelector("h1").innerHTML = " Player 1 and 3  Wins!"
}
else {
